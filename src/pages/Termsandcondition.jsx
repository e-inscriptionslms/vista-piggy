                ...
                <div className="row">
                    <div className="col-sm-8 mt-4 ">
                        <div className="col-sm-12 p-4 about">
                            <h1 className="about_text">TERMS AND CONDITIONS</h1>
                            <hr />
                            <p>Welcome to hopiffy!</p>
                            <p>These terms and conditions outline the rules and regulations for the use of hopiffy's Website,
                                located at <a href=" https://hopiffy.com/."> https://hopiffy.com/</a>
                            </p>
                            <p>By accessing this website we assume you accept these terms and conditions. Do not continue
                                to use hopiffy if you do not agree to take all of the terms and conditions stated on this page.
                            </p>
                            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
                                ...
                                in. Any use of the above terminology or other words in the singular, plural, capitalization and/or
                                he/she or they, are taken as interchangeable and therefore as referring to same.
                            </p>
                            <b>Cookies
                            </b>
                            <p>We employ the use of cookies. By accessing hopiffy, you agreed to use cookies in agreement
                                with the hopiffy's Privacy Policy.
                            </p>
                            ...
                            <p>Unless otherwise stated, hopiffy and/or its licensors own the intellectual property rights for all
                                material on hopiffy. All intellectual property rights are reserved. You may access this from hopiffy
                                for your own personal use subjected to restrictions set in these terms and conditions.
                            </p>
                            <b>You must not:
                            </b>
                            <ul>
                                <li>Republish material from hopiffy</li>
                                <li>Sell, rent or sub-license material from hopiffy</li>
                                <li>Reproduce, duplicate or copy material from hopiffy</li>
                                <li>Redistribute content from hopiffy</li>
                            </ul>
                            <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the
                                help of the Free Terms and Conditions Generator</p>
                            <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                                information in certain areas of the website. hopiffy does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and
                                opinions of hopiffy,its agents and/or affiliates. Comments reflect the views and opinions of the
                                person who post their views and opinions. To the extent permitted by applicable laws, hopiffy
                            ...
                            <p>hopiffy reserves the right to monitor all Comments and to remove any Comments which can be
                            ...
                            <p>You hereby grant hopiffy a non-exclusive license to use, reproduce, edit and authorize others to
                                use, reproduce and edit any of your Comments in any and all forms, formats or media</p>
                            <b>Hyperlinking to our Content
                            </b>
                            ...
                            <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                                ...
                                hyperlink compensates the absence of hopiffy; and (d) the link is in the context of general
                            ...
                            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                                our website, you must inform us by sending an e-mail to hopiffy. Please include your name, your
                            ...
                            <p>No use of hopiffy's logo or other artwork will be allowed for linking absent a trademark license
                                agreement.
                            </p>
                            <b>iFrames</b>
                            ...
                            <b>Removal of links from our website
                            </b>
                            <p>f you find any link on our Website that is offensive for any reason, you are free to contact and
