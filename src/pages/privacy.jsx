        ...
        <div className="row">
          <div className="col-sm-8 mt-4 ">
            <div className="col-sm-12 p-4 about">
              <h1 className="about_text">Privacy Policy</h1>
              <h4>Privacy Policy for HOPIFFY</h4>
              ...
              <p>Country refers to: Madhya Pradesh, India
              </p>
              ...
              <p>Website refers to hopiffy, accessible from <a href="https://hopiffy.com">https://hopiffy.com</a> </p>
              ...
              <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store
                certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may
                include:
              </p>
              <p>· Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can
                ...
                have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</p>
              ...
              <p>With Affiliates: We may share Your information with Our affiliates, in which case we will
                ...
                under common control with Us</p>
              <p>· With business partners: We may share Your information with Our business partners to
              ...
              <p>With Your consent: We may disclose Your personal information for any other purpose with
                Your consent.</p>
              ...
              <p>· By email: <a href="support@hopiffy.com">support@hopiffy.com</a></p>
            </div>
          </div>
